...
const getDetailMovie = async (movieDetailUrl) => {
   try {
      ...
      const rowHtml = `
               <div class="row">
                  <div class="col-sm-3" style="text-align:center">
                     <img src="${imgSrc}" alt="${data.title}" style ="max-width:100%" class="poster-detail" />
                  </div>
      ...
      await getCreditsMovie(movieCreditsUrl) // getDetailMovie 함수가 완료될때까지 기다렸다가 getCreditsMovie 함수 실행
   } catch (error) {
